...
<template>
  <div class="bigbox" v-cloak>
    ...
    <div class="content">
      <div v-if="this.hrList.length === 0" class="noshowbox">企业还没HR发来申请</div>
          ...
          <div class="context" v-for="(n, inx) in hrList" :key="inx">
            ...
            <div class="mincontext">
              ...
              <div class="namebox">{{ n.department }}</div>
               <el-button type="primary" @click="agreeHr(n.hrid)">同意</el-button>
              <el-button type="danger" @click="rejectHr(n.hrid)">拒绝</el-button>
            </div>
          </div>
        </div>
      </div>
